...
import com.jahanzaib.themoviedb.presenter.mvp.presenter.MovieDetailPresenter;
...
public class MovieDetailFragment extends BaseFragment implements MovieDetailView {
    ...
    public void configureGUI() {
        ...
        Utility.setContentBehindToolbar((BaseActivity) getActivity());
        configureScrollFade();
    }
    ...
    public void updateBackground(String value) {
        TheMovieDB.PICASSO.load(value).into(coverImage, new Callback() {
            @Override
    ...
    public void updateToolbarColor() {
        ...
        int titleColor = Utility.getAlphaColor(Color.WHITE, scrollRatio);
