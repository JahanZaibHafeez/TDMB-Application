...
import com.jahanzaib.themoviedb.presenter.ui.fragment.PopularMoviesFragment;
import com.jahanzaib.themoviedb.presenter.ui.fragment.TopRatedMoviesFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_popular) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(PopularMoviesFragment.newInstance(),"")
                    .commit();
        } else if (id == R.id.top_rated) {
            setToolbar("Top Rated Movies");
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(TopRatedMoviesFragment.newInstance(),"")
                    .commit();
