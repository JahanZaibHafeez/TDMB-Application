...
import com.jahanzaib.themoviedb.apicalls.usecase.GetPopularMoviesUseCase;
...
public class PopularMoviesPresenter implements BasePresenter {
    ...
    public PopularMoviesPresenter(SearchMoviesView view) {
        this.view =view;
    ...
    public void performSearch() {
        ...
        TheMovieDB.JOB_MANAGER.addJobInBackground(new GetPopularMoviesUseCase(apiKey, new GetPopularMoviesUseCase.GetPopularMovieUseCaseCallback() {
            @Override
